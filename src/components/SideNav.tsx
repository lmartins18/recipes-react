...
export const SideNav = () => {
  ...
  return (
    <>
      <button
        className="inline-block rounded bg-primary px-6 text-xs font-medium uppercase text-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg"
        data-te-sidenav-toggle-re
        onClick={toggleNav}
      >
      ...
      {nav && (
        <nav
          id="sidenav-1"
          className="fixed left-0 top-0 z-[1035] h-full w-60 -translate-x-full  bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
